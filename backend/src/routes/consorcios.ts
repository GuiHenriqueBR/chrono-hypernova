...
router.get('/:id/lances', asyncHandler(async (req: Request, res: Response) => {
  const { id } = req.params;
...
// Registrar lance
router.post('/:id/lances', asyncHandler(async (req: Request, res: Response) => {
  const { id } = req.params;
  const userId = (req as any).user?.id;
...
router.patch('/:id/lances/:lanceId', asyncHandler(async (req: Request, res: Response) => {
