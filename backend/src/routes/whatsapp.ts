...
// Listar conversas
router.get('/conversas', asyncHandler(async (req: Request, res: Response) => {
...
router.get('/conversas/:conversaId/mensagens', asyncHandler(async (req: Request, res: Response) => {
...
// Enviar mensagem
router.post('/enviar', asyncHandler(async (req: Request, res: Response) => {
...
router.get('/templates/categorias', asyncHandler(async (req: Request, res: Response) => {
  const categorias = [
...
router.get('/templates/variaveis', asyncHandler(async (req: Request, res: Response) => {
  const variaveis = [
...
router.post('/templates/:id/usar', asyncHandler(async (req: Request, res: Response) => {
  const { id } = req.params;
...
router.post('/templates/processar', asyncHandler(async (req: Request, res: Response) => {
...
router.post('/conversas/:conversaId/vincular', asyncHandler(async (req: Request, res: Response) => {
  const { conversaId } = req.params;
...
router.patch('/conversas/:conversaId/status', asyncHandler(async (req: Request, res: Response) => {
  const { conversaId } = req.params;
...
router.post('/instancia/criar', asyncHandler(async (req: Request, res: Response) => {
  ...
  try {
    ...
    const existingInstance = checkResponse.data?.find((inst: any) => inst.instance?.instanceName === instanceName);
    ...
    logger.error('Erro ao criar instancia:', error.response?.data || error.message);
    res.status(500).json({
  ...
  try {
    ...
    if (error.response?.status === 404 || error.response?.data?.error?.includes('not found')) {
      try {
        ...
        logger.error('Erro ao criar instancia:', createError.response?.data || createError.message);
      }
    }
...
router.post('/desconectar', asyncHandler(async (req: Request, res: Response) => {
  try {
    ...
    logger.error('Erro ao desconectar:', error.response?.data || error.message);
    res.status(500).json({
...
// Reiniciar instancia
router.post('/reiniciar', asyncHandler(async (req: Request, res: Response) => {
  try {
...
router.get('/info', asyncHandler(async (req: Request, res: Response) => {
  try {
    ...
    const instance = response.data?.find((inst: any) => inst.instance?.instanceName === EVOLUTION_INSTANCE);
    ...
    logger.error('Erro ao buscar info:', error.response?.data || error.message);
    res.json({
      success: false,
      instancia: EVOLUTION_INSTANCE,
...
router.post('/webhook/configurar', asyncHandler(async (req: Request, res: Response) => {
...
router.post('/enviar-midia', asyncHandler(async (req: Request, res: Response) => {
  ...
  try {
    ...
    logger.error('Erro ao enviar midia:', error.response?.data || error.message);
    res.status(500).json({
