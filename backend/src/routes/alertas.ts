...
router.get('/resumo', asyncHandler(async (req: Request, res: Response) => {
  const userId = (req as any).user?.id;
...
router.get('/contagem', asyncHandler(async (req: Request, res: Response) => {
  const userId = (req as any).user?.id;
...
router.patch('/:id/lido', asyncHandler(async (req: Request, res: Response) => {
  const userId = (req as any).user?.id;
  const { id } = req.params;
...
router.post('/marcar-todos-lidos', asyncHandler(async (req: Request, res: Response) => {
  const userId = (req as any).user?.id;
...
router.delete('/lidos/todos', asyncHandler(async (req: Request, res: Response) => {
  const userId = (req as any).user?.id;
...
router.post('/admin/verificar', asyncHandler(async (req: Request, res: Response) => {
...
// Status do scheduler
router.get('/admin/scheduler-status', asyncHandler(async (req: Request, res: Response) => {
...
router.get('/admin/estatisticas', asyncHandler(async (req: Request, res: Response) => {
  // Total de alertas
